export default {
  ...
  rules: {
    ...
    'no-unneeded-ternary': 'error', // 避免不需要的三元表达式 Do not nest ternary expressions.
    ...
    camelcase: [ 'error', { properties: 'always' } ], // 要求驼峰式命名对象、函数、实例 Identifier xxxxxx is not in camel case.
